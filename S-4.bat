...
echo ==============================
echo.
echo 1. Creación del proyecto 4 Capas
...
:selectName
SET /P projectName="Introduce el nombre del proyecto:(Se recomienda colocar el nombre de la carpeta del repo)"
dotnet new sln
...
echo "!DIR_EJECUCION!"
pause
dotnet sln "!DIR_EJECUCION!\!projectName!.sln" add "!folderName!\!folderName!.csproj"
dotnet sln "!DIR_EJECUCION!\!projectName!.sln" add "!app!\!app!.csproj"
dotnet sln "!DIR_EJECUCION!\!projectName!.sln" add "!dom!\!dom!.csproj"
dotnet sln "!DIR_EJECUCION!\!projectName!.sln" add "!persistencia!\!persistencia!.csproj"
